...
"C:\Program Files\IAR Systems\Embedded Workbench 5.4\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\avrJtagIce.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\bin\<libsupport_plugin>" --backend -B "--cpu=m128" "--enhanced_core" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.4\avr\Config\iom128.ddf" "--eeprom_size" "4096" "-d" "jtagIce" "--drv_communication=COM2" "--jtagice_clock=540000" "--jtagice_leave_timers_running" "--drv_set_putchar_breakpoint" "--drv_set_getchar_breakpoint" 
